        ...
        if (mysqli_query($conn, $sql)) {
            ...
            <html lang="en">
              ...
              <body>
                ...
                <p>Klik <a href="http://www.project-periode-3.org/index.php?content=activate&id=' . $id . '&pwh=' . $array['password_hash'] . '">hier</a> voor het activeren en wijzigen van het wachtwoord van uw account</p>
            ...
            // More headers
            $headers .= 'From: <BipolarStoornis@gmail.com>' . "\r\n";
